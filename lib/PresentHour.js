      ...
      if (shouldDisplay) {
        return _react2.default.createElement(
          ...
          _react2.default.createElement(
            'div',
            { style: { position: 'relative', color: 'white', width: '51px', height: '17px', borderRadius: '6px', backgroundColor: '' + color, fontSize: '10px', padding: '2px 10px', marginLeft: 'calc(' + this.state.presentTimeLocation + 'px - 25px)', zIndex: 2 } },
            this.state.hour
          ),
          this.props.children,
