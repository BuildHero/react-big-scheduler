...
var PresentHour = (_temp = _class = function (_Component) {
  _inherits(PresentHour, _Component);

  function PresentHour(props) {
    _classCallCheck(this, PresentHour);

    var _this = _possibleConstructorReturn(this, (PresentHour.__proto__ || Object.getPrototypeOf(PresentHour)).call(this, props));
      ...
      if (shouldDisplay) {
        return _react2.default.createElement(
          ...
          _react2.default.createElement(
            'div',
            { style: { position: 'relative', color: 'white', width: '51px', height: '17px', borderRadius: '6px', backgroundColor: 'rgb(23, 41, 77)', fontSize: '10px', padding: '2px 10px', marginLeft: 'calc(' + this.state.presentTimeLocation + 'px - 25px)', zIndex: 2 } },
            this.state.hour
          ),
          this.props.children,
  ...
  this.tick = function () {
    ...
    _this2.setState({ presentTime: ptime, presentTimeLocation: location, hour: (0, _moment2.default)().format('hh:mm') });
  };
}, _temp);
exports.default = PresentHour;