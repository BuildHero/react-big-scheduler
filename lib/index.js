...
var _PresentTime = require('./PresentTime');

var _PresentTime2 = _interopRequireDefault(_PresentTime);

var _PresentHour = require('./PresentHour');

var _PresentHour2 = _interopRequireDefault(_PresentHour);
...
var Scheduler = (_temp = _class = function (_Component) {
        ...
        value: function render() {
                            ...
                            _react2.default.createElement(
                                ...
                                _react2.default.createElement(
                                    ...
                                    _react2.default.createElement(
                                        ...
                                        _react2.default.createElement(
                                            'div',
                                            { className: 'scheduler-content', style: { display: 'inline-block' } },
                                            _react2.default.createElement(
                                                _PresentHour2.default,
                                                { shouldDisplay: config.showPresentTime && viewType === _ViewTypes2.default.Day && schedulerData.startDate === localeMoment().format(DATE_FORMAT), color: config.presentTimeColor, cellWidth: config.dayCellWidth, minuteStep: config.minuteStep },
                                                _react2.default.createElement(
                                                    'table',
            ...
            if (config.headerEnabled) {
                if (config.headerTemplate) {
                    schedulerHeader = config.headerTemplate;
                } else {
            ...
            var processingTag = schedulerData.processing ? _react2.default.createElement(
                'div',
                { style: {
                        width: '100%',
                        height: '100%',
                ...
                _react2.default.createElement(
                    'div',
                    { style: { color: '' + config.presentTimeColor, marginTop: config.schedulerMaxHeight / 2 + 50 + 'px', zIndex: 1001 } },
    ...
    rightClickEvent: _propTypes.PropTypes.func,
    ...
    eventItemContextMenuResolver: _propTypes.PropTypes.func,
    ...
    this.resolveScrollbarSize = function (props, state) {
        if (!props) props = _this3.props;
        if (!state) state = _this3.state;
        var _props2 = props,
        ...
        var tmpState = {};
        var needSet = false;
        if (contentScrollbarHeight < _this3.state.contentScrollbarHeight - 1 || contentScrollbarHeight > _this3.state.contentScrollbarHeight + 1) {
            tmpState = _extends({}, tmpState, { contentScrollbarHeight: contentScrollbarHeight });
            needSet = true;
        }
        if (contentScrollbarWidth < _this3.state.contentScrollbarWidth - 1 || contentScrollbarWidth > _this3.state.contentScrollbarWidth + 1) {
        ...
        if (resourceScrollbarHeight < _this3.state.resourceScrollbarHeight - 1 || resourceScrollbarHeight > _this3.state.resourceScrollbarHeight + 1) {
            tmpState = _extends({}, tmpState, { resourceScrollbarHeight: resourceScrollbarHeight });
            needSet = true;
        }
        if (resourceScrollbarWidth < _this3.state.resourceScrollbarWidth - 1 || resourceScrollbarWidth > _this3.state.resourceScrollbarWidth + 1) {
    ...
    this.onSchedulerContentScroll = function (proxy, event) {
        ...
        var _props3 = _this3.props,
            ...
            onScrollLeft = _props3.onScrollLeft,
            onScrollRight = _props3.onScrollRight,
            onScrollTop = _props3.onScrollTop,
            onScrollBottom = _props3.onScrollBottom;
    ...
    this.onSelect = function (date) {
        ...
        var _props7 = _this3.props,
            onSelectDate = _props7.onSelectDate,
