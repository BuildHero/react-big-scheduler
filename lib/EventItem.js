...
var EventItem = (_temp = _class = function (_Component) {
    ...
    _createClass(EventItem, [{
        ...
        value: function render() {
            ...
            var eventItemContextMenu = _react2.default.createElement('div', null);
            if (eventItemContextMenuResolver !== undefined) {
                ...
                eventItemContextMenu = _react2.default.createElement('div', null);
            }
    ...
    this.doStartDrag = function (ev) {
        ...
        if (_this3.mounted) _this3.setState({ left: newLeft, width: newWidth });
    };
