...
var EventItem = (_temp = _class = function (_Component) {
    ...
    _createClass(EventItem, [{
        ...
        value: function render() {
            ...
            var _props = this.props,
                ...
                eventItemContextMenuResolver = _props.eventItemContextMenuResolver;
            ...
            var eventItemContextMenu = _react2.default.createElement(
                _reactContextmenu.ContextMenu,
                {
                    id: 'eventitem_identifier',
                    onShow: function onShow() {
                        _this2.setState({ hidePopover: true });
                    },
                    onHide: function onHide() {
                        _this2.setState({ hidePopover: false });
                    }
                },
                _react2.default.createElement(
                ...
                _react2.default.createElement(_reactContextmenu.MenuItem, { divider: true }),
                _react2.default.createElement(
                    _reactContextmenu.MenuItem,
                    null,
            ...
            if (eventItemContextMenuResolver !== undefined) {
                var contextmenu = eventItemContextMenuResolver(schedulerData, eventItem);
                var hideOnLeave = contextmenu.hideOnLeave,
                    className = contextmenu.className,
                    _onHide = contextmenu.onHide,
                    _onShow = contextmenu.onShow,
                ...
                eventItemContextMenu = _react2.default.createElement(
                    _reactContextmenu.ContextMenu,
                    _extends({
                        id: 'eventitem_identifier',
                    ...
                    menuItems.map(function (menuItem) {
                        var submenus = menuItems.submenus;
                        var menuItemProps = _extends({}, menuItem);
                        delete menuItemProps.label;
                        return _react2.default.createElement(
                            _reactContextmenu.MenuItem,
                            _extends({ key: menuItemProps.id }, menuItemProps),
                            menuItem.label
                        );
                    })
                );
            ...
            return isDragging ? null : schedulerData._isResizing() || config.eventItemPopoverEnabled == false || eventItem.showPopover == false || this.state.hidePopover === true ? _react2.default.createElement(
                'div',
                null,
    ...
    eventItemContextMenu: _propTypes.PropTypes.func
